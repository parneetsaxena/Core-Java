...
Generics provide type safety. Generics allows us to define data types and only works with classes.
 */
...
public class CollectionsIntro {
    public static void main(String[] args) {
        // This is using the Collection interface and creating an instantiation of the ArrayList class. The raw type of this variable is object.
        ...
        // The above example is valid but does not define a datatype. It is not type safe and can store all types of value. We use generics for type safety.
